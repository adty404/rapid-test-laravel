...
<body>
    <div class="card">
                ...
                <div class="col-6">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <td>Usia</td>
                            <td>:</td>
                            <td>{{ \Carbon\Carbon::now()->format('Y') - \Carbon\Carbon::parse($test_result->patientRegister->patient->birth_date)->format('Y') . ' Tahun'  }}</td>
                        </tr>
                        <tr>
                            <td>Alamat</td>
                            <td>:</td>
        ...
        <p style="padding-left: 50%;">
            Tanggal Selesai : {{ \Carbon\Carbon::parse($test_result->patientRegister->start_date)->isoFormat('d MMMM Y')
